<template>
    ...
    <el-row class="member-manage">
        <p style="color:#999">*注<strong>: </strong>测试结果会发送给项目成员</p>
...
<script>
    import { getCaseProjectMemberList, getCaseProjectEmail, delCaseProjectEmail, addCaseProjectEmail} from "../../api/api";
    export default {
        data() {
            return {
                memberData: [],
                total: 1,//页码显示的数字总个数，设置最大页码按钮数
                page: 1,
                listLoading: false,
                reportFrom: "",
        ...
        methods: {
            ...
            getProjectMember() {
                ...
                console.log(params.caseProject_id);
                ...
                getCaseProjectMemberList(headers, params).then(_data => {
            ...
            getEmailConfig(){
                ...
                getCaseProjectEmail(headers, params).then(_data => {
                    let {msg, code, data} = _data;
                    self.listLoading = false;
                    if (code === '999999') {
                        console.log(data);
            ...
            DelEmail(){
                ...
                delCaseProjectEmail(headers, params).then(_data => {
                    let {msg, code, data} = _data;
                    self.listLoading = false;
                    if (code === '999999') {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            addCaseProjectEmail(headers, params).then(_data => {
                                let {msg, code, data} = _data;
