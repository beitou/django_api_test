    ...
    <section>
        <el-row :span="24" class="row-title">
            <el-col :span="4">
                ...
                <router-link :to="{ name: 'Postman', params: {project_id: this.$route.params.project_id}}"
                             style='text-decoration: none;color: aliceblue;'>
                    <el-button class="addGroup">Postman</el-button>
                </router-link>
                <el-row class="tac">
                    <el-col>
                        <el-menu
                            ...
                            <el-menu-item index="2">
                                ...
                                <!--<span slot="title">-->
                                    <router-link
                                        :to="{ name: '接口列表', params: {project_id: this.$route.params.project_id}}"
                                        style='text-decoration: blue;color: #303133;'>
                                        接口列表
                                </router-link>
                            </el-menu-item>
                            <el-submenu index="1">
                                ...
                                <el-menu-item-group style="overflow: auto;">
                                    <template v-for="(item,index) in groupData">
                                        <router-link
                                                :to="{ name: '分组接口列表', params: {project_id: project, firstGroup: item.id}}"
                                                style="text-decoration:none;">
                                            <el-menu-item :index="'1-'+index" :key="item.id" class="group">
                                                <template slot="title">
                                                    <div style="text-overflow:ellipsis;white-space: nowrap;overflow:hidden;width: 99%;">
                                                        {{item.name}}
                                                    </div>
                                                    <el-dropdown trigger="hover" class="editGroup"
                                                                 style="margin-right:10%;position: absolute; top: 2px;right: 0;">
                                                        <i class="el-icon-more"></i>
                                                        <el-dropdown-menu slot="dropdown">
                                                            <el-dropdown-item @click.native="handleDelFirst(item.id)">
                                                                删除
                                                            </el-dropdown-item>
                                                            <el-dropdown-item
                                                                    @click.native="handleEditFirstGroup(item.id, item.name)">
                                                                修改
                                                            </el-dropdown-item>
                                                        </el-dropdown-menu>
                                                    </el-dropdown>
            ...
            <!--新增-->
            <el-dialog title="新增分组" :visible.sync="addGroupFormVisible" :close-on-click-modal="false"
            ...
            <!--编辑父分组-->
            <el-dialog title="编辑分组" :visible.sync="editFirstGroupFormVisible" :close-on-click-modal="false"
                       style="width: 60%; left: 20%">
                <el-form :model="editFirstGroupForm" label-width="80px" :rules="editFirstGroupFormRules"
                         ref="editFirstGroupForm">
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click.native="editFirstGroupSubmit" :loading="editFirstGroupLoading">提交
                    </el-button>
                </div>
            </el-dialog>
            <el-col :span="20">
