        ...
        <el-form :model="form" ref="form" :rules="FormRules">
            <div style="border: 1px solid #e6e6e6;margin-bottom: 10px;padding:15px">
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="3" v-if="form.requestType!=='DUBBO'">
                        <el-form-item>
                    ...
                    <el-col :span='9' v-if="form.requestType==='DUBBO'">
            ...
            <el-row :span="24">
                <el-collapse v-model="activeNames" @change="handleChange">
                    ...
                    <el-collapse-item title="请求参数" name="2">
                        ...
                        <el-table ref="multipleParameterTable" :data="form.requestList" highlight-current-row :class="ParameterTyep? 'parameter-a': 'parameter-b'">
...
<script>
    import { addApiDetail, getApiGroupList, getHost } from "../../../api/api";
                ...
                if (temp.indexOf("?")>0) {
                    ...
                    a.forEach(
                        a => {
                            ...
                            this.form.requestList.push(parameter);
                        }
                    );
            ...
            getHosts() {
                ...
                getHost(headers, params).then(_data => {
                    ...
                    if (code === '999999') {
                        ...
                        self.form.host_id = self.hosts[0].id;
                    }
