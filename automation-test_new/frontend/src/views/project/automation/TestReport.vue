<template>
    <section>
        <el-button class="return-list" @click="back"><i class="el-icon-d-arrow-left" style="margin-right: 5px"></i>计划列表</el-button>
        ...
        <div>
            <el-table :data="tableData" v-loading="listLoading" :row-style="tableRowStyle" @expand-change="showJson">
                ...
                <el-table-column prop="automationTestSchedule" label="计划名称" min-width="29%" sortable show-overflow-tooltip>
                </el-table-column>
