<template>
    <div class="homeBox">
        ...
        <div style="width:32%;height: auto;margin-left: 30%">
            <div class="title0">小帮规划质量控制中心</div>
            <div class="title1">项目管理、接口管理、计划管理、测试报告、任务设置</div>
        ...
        <el-form  @keyup.enter.native="handleSubmit2" :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
            ...
            <el-form-item style="width:100%;" :inline="true">
                ...
                <el-button type="primary" style="width:45%;position: absolute;right:0" @click.native.prevent="handleReset2">重置</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
