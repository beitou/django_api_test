...
logfile = "/home/sysop/task/" + runtime+'.log'
...
def task_start_timing():
    ...
    job = my_user_cron.new(command='sudo -i python3 /home/sysop/workspace/QCC-master/api_test/common/auto_test.py %s %s  >> '
                                   '/home/sysop/task/%s.log '
                                   % (sys.argv[3], sys.argv[8], sys.argv[8]))
    ...
    jobs = end_task.new(command='sudo -i python3 /home/sysop/workspace/QCC-master/api_test/common/end_task.py %s >> '
                                '/home/sysop/task/%s.log '
